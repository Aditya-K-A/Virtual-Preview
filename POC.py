...
if st.button("Generate Outfit Suggestions"):
    if uploaded_file:
        ...
        if not face_image_base64:
            ...
            prompts = [
                (
                    f"A full-body image of an {ethinicity.lower()} {gender.lower()} in their {age.lower()}, with a {color_complexion.lower()} and a {body_type.lower()} {body_shape.lower()} shaped body, dressed for a {occasion.lower()} for the {season.lower()} season, with a clearly visible head and face. "
